...
classif.cforest = makeUniversalLearnerThresh0.9("classif.cforest") 
...
# Task: long method
# Learner: classif.cforest
# Aggr perf: multiclass.AvFbeta.test.mean=0.6058148
# Runtime: 203.487

#############

classif.ctree = makeUniversalLearnerThresh0.9("classif.ctree") 
...
# Task: long method
# Learner: classif.ctree
# Aggr perf: multiclass.AvFbeta.test.mean=0.5831925
# Runtime: 1.02545

#############

classif.rpart = makeUniversalLearnerThresh0.9("classif.rpart") 
...
classif.evtree = makeUniversalLearnerThresh0.9("classif.evtree") 
classif.evtree.resample.rep10cv10stratify = tryLoadResample(outputFolder, 
                                                                "classif.evtree.resample.rep10cv10stratify.RDS", 
                                                                save = TRUE, 
                                                                ...
                                                                measures = myMeasures)
sinkOn()
classif.evtree.resample.rep10cv10stratify
sink()


#############

classif.randomForest = makeUniversalLearnerThresh0.9("classif.randomForest") 
classif.randomForest.resample.rep10cv10stratify = tryLoadResample(outputFolder, 
                                                                      "classif.randomForest.resample.rep10cv10stratify.RDS", 
                                                                      save = TRUE, 
                                                                      ...
                                                                      measures = myMeasures)
sinkOn()
classif.randomForest.resample.rep10cv10stratify
sink()


#############

classif.ranger = makeUniversalLearnerThresh0.9("classif.ranger") 
classif.ranger.resample.rep10cv10stratify = tryLoadResample(outputFolder,
                                                                "classif.ranger.resample.rep10cv10stratify.RDS",
                                                                save = TRUE,
                                                                ...
                                                                measures = myMeasures)
sinkOn()
classif.ranger.resample.rep10cv10stratify
sink()
...
# Aggr perf: multiclass.AvFbeta.test.mean=0.6174213
# Runtime: 65.862
...
#-- Training final model
myFinalLearner <- classif.randomForest
myFinalModelTrained <- tryLoad(folder = outputFolder, 
                               filename = str_c("FinalTrainedLearner.", myFinalLearner$id, ".RDS"), 
                               save = TRUE,
                               expr = {
