...
argv$version = "RC1.1"
argv$investigatedSmell = "data class" #"blob", "data class", "long method", "feature envy"
...
# Aggr perf: multiclass.AvFbeta.test.mean=0.3525075
# Runtime: 246.765
# > classif.sda.resample.rep10cv10stratify
# Resample Result
# Task: feature envy
...
# Task: blob
# Learner: ensembleSDA.learnersNAI
# Aggr perf: multiclass.AvFbeta.test.mean=0.1425397
# Runtime: 2887.04
...
# Train model: ensembleSDA.learnersNAI
myFinalLearner <- ensembleSDA.learnersNAI
myFinalModelTrained <- tryLoad(folder = outputFolder, 
                               filename = str_c("FinalTrainedLearner.", myFinalLearner$id, ".RDS"), 
                               save = TRUE,
                               expr = {
